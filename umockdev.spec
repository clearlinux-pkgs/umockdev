...
Source0  : https://github.com/martinpitt/umockdev/releases/download/0.18.3/umockdev-0.18.3.tar.xz
...
%prep
%setup -q -n umockdev-0.18.3
cd %{_builddir}/umockdev-0.18.3
pushd ..
cp -a umockdev-0.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720113532
