...
Source0  : https://github.com/martinpitt/umockdev/releases/download/0.17.13/umockdev-0.17.13.tar.xz
...
%prep
%setup -q -n umockdev-0.17.13
cd %{_builddir}/umockdev-0.17.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654016652
...
cp %{_builddir}/umockdev-0.17.13/COPYING %{buildroot}/usr/share/package-licenses/umockdev/01a6b4bf79aca9b556822601186afab86e8c4fbf
