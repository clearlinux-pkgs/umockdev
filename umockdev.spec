...
Version  : 0.17.10
Release  : 1
URL      : https://github.com/martinpitt/umockdev/releases/download/0.17.10/umockdev-0.17.10.tar.xz
Source0  : https://github.com/martinpitt/umockdev/releases/download/0.17.10/umockdev-0.17.10.tar.xz
...
%prep
%setup -q -n umockdev-0.17.10
cd %{_builddir}/umockdev-0.17.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652830797
...
cp %{_builddir}/umockdev-0.17.10/COPYING %{buildroot}/usr/share/package-licenses/umockdev/01a6b4bf79aca9b556822601186afab86e8c4fbf
